package com.sunmoon.platform.transport.http.bo.commoncode;
...
/** DELETE /bo/common-code — key given in the body, since there's no path-variable routing (see RestRequestRouter). */
public final class DeleteCommonCodeEndpoint implements RestEndpoint {

    private record DeleteRequest(@NotBlank String groupCode, @NotBlank String code) {
    }
    ...
    public DeleteCommonCodeEndpoint(CommonCodeRepository repository) {
    ...
    public FullHttpResponse handle(FullHttpRequest request) {
        ...
        repository.delete(body.groupCode(), body.code());
